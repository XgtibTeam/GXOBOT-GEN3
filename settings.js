...
global.APIKeys = {
	'https://alphabot-api.herokuapp.com': 'hB8KKEb9',  // 👉 login https://api.zeeoneofc.xyz to get apikey || https://api-alphabot.herokuapp.com
}
...
// Other
// Other
global.botname = "GXOBot-Mdོོ" //namabot kalian
global.ownername= "XgtibXcybོ ×፝֟͜×" //nama kalian
global.myweb ="https://s.id/gxobot" //bebas asal jan hapus
global.youtube = "https://youtube.com/channel/UCtM-pDaaGVRe4BJ7w4qE4Bw" //bebas asal jan hapus
global.myweb2 = "www.instagram.com/xgtib" //bebas
...
global.thumbnail = "./image/Xgtib.jpg" // ini lol.jpg adalah nama foto di folder image. untuk foto bot
global.donasi = "./image/qris.jpg" // foto donasi di folder image
global.background_welcome="https://telegra.ph/file/90a931648de597820bc08.jpg" // maks size 30kb, agar welcome image nya tdk delay
global.thumbGif = 'https://telegra.ph/file/e90bef3779d3c5812a5d1.mp4'
global.packname = '© GXOBot-Mdོོ' //sticker wm ubah
global.author = 'Di Buat Oleh XgtibXcybོ' //sticker wm ganti nama kalian
...
global.mess = {
    sukses: 'Udah Kids',
    admin: 'Admin dulu dek baru pake fitur ini',
    botAdmin: 'Adminin gw dulu lah baru fitur nya bisa dipake',
    owner: 'Owner dulu kids baru pake ini',
    group: 'Cuma bisa di grup yah dek',
    private: 'Gabisa disini,bisanya di Private chat aja xD',
	bot: 'Buat yang udah tobat aja🤓',
    errtoimg: 'Belum bisa Gif yah, coba yang lain aja',
    wait: 'Sabar Brother🤓',
	lockCmd: 'Ownernya gamau ngasih fitur ini,bayar dulu katanya🤓',
	example1: 'Wellcome Brother @user Di Group @subject Jangan Lupa Baca Rules @desc\n\nNote :\n1. @user (Mention User Join)\n2. @bio (Get Bio User Join)\n3. @tanggal (Date Now)\n4. @desc (Get Description Group)\n5. @subject (Group Name)'
}
